...
public class ContextBasedManagementController {
  ...
  public TestPlan testPlan(
      @ApiParam(value = "the id of the test plan",
          required = true) @PathVariable final Long testPlanId,
      HttpServletRequest request, HttpServletResponse response) throws Exception {
  ...
  @RequestMapping(value = "/testPlans/{testPlanId}/testCases/{testCaseId}/delete",
      method = RequestMethod.POST, produces = "application/json")
  public ResourceUploadStatus deleteTestCase(HttpServletRequest request,
      @PathVariable("testCaseId") Long testCaseId, @PathVariable("testPlanId") Long testPlanId,
  ...
  @PreAuthorize("hasRole('tester')")
  @RequestMapping(value = "/testCaseGroups/{testCaseGroupId}/testCases/{testCaseId}/delete",
      method = RequestMethod.POST, produces = "application/json")
  ...
  @PreAuthorize("hasRole('tester')")
  @RequestMapping(value = "/testCases/{testCaseId}/testSteps/{testStepId}/delete",
      method = RequestMethod.POST, produces = "application/json")
  public ResourceUploadStatus deleteTestStep(HttpServletRequest request,
      @PathVariable("testStepId") Long testStepId, @PathVariable("testCaseId") Long testCaseId,
      Principal p) throws Exception {
    checkManagementSupport();
  ...
  @RequestMapping(value = "/testSteps/{testStepId}/name", method = RequestMethod.POST,
      produces = "application/json")
  public ResourceUploadStatus deleteTestStep(HttpServletRequest request,
      @PathVariable("testStepId") Long testStepId, Principal p, @RequestBody String name)
      throws Exception {
    checkManagementSupport();
    TestStep testStep = testStepService.findOne(testStepId);
    checkPermission(testStepId, testStep, p);
  ...
  public ResourceUploadStatus updateTestCaseName(HttpServletRequest request,
      @PathVariable("testCaseId") Long testCaseId, Principal p, @RequestBody String name)
      throws Exception {
    checkManagementSupport();
    TestCase testCase = testCaseService.findOne(testCaseId);
    checkPermission(testCaseId, testCase, p);
  ...
  public ResourceUploadStatus updateTestPlanName(HttpServletRequest request,
      @PathVariable("testPlanId") Long testPlanId, Principal p, @RequestBody String name)
      throws Exception {
    checkManagementSupport();
    TestPlan testPlan = testPlanService.findOne(testPlanId);
    checkPermission(testPlanId, testPlan, p);
  ...
  @RequestMapping(value = "/testPlans/{testPlanId}/publish", method = RequestMethod.POST,
      produces = "application/json")
  public ResourceUploadStatus publishTestPlan(HttpServletRequest request,
      @PathVariable("testPlanId") Long testPlanId, Principal p) throws Exception {
    checkManagementSupport();
    TestPlan testPlan = testPlanService.findOne(testPlanId);
    checkPermission(testPlanId, testPlan, p);
  ...
  @RequestMapping(value = "/testPlans/{testPlanId}/testCaseGroups/{testCaseGroupId}/delete",
      method = RequestMethod.POST, produces = "application/json")
  ...
  @RequestMapping(
      value = "/testCaseGroups/{parentTestCaseGroupId}/testCaseGroups/{testCaseGroupId}/delete",
      method = RequestMethod.POST, produces = "application/json")
  ...
  @PreAuthorize("hasRole('tester')")
  @RequestMapping(value = "/artifacts/{artifactId}", method = RequestMethod.POST,
      produces = "application/json", consumes = {"application/x-www-form-urlencoded;"})
  public ResourceUploadStatus updateArtifact(HttpServletRequest request,
      @PathVariable("artifactId") Long artifactId, @RequestParam("content") String content,
  ...
  @PreAuthorize("hasRole('tester')")
  @RequestMapping(value = "/artifacts/{artifactId}/delete", method = RequestMethod.POST,
      produces = "application/json")
  public ResourceUploadStatus deleteArtifact(HttpServletRequest request,
      @PathVariable("artifactId") Long artifactId, Principal p) throws Exception {
    checkManagementSupport();
    // String username = null;
    String username = userIdService.getCurrentUserName(p);
    if (username == null)
