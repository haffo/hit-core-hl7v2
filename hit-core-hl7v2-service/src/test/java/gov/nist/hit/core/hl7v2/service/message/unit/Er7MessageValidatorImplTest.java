...
public class Er7MessageValidatorImplTest {
	...
	@Test
	public void testValidateWithProfile() throws MessageParserException,
			IOException, ValidationException {
		String report = validator.validatetoJson("JunitTest", getEr7Message(),
				getProfile(), getConstraints(), null);
