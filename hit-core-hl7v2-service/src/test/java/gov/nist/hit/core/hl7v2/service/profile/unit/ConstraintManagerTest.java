...
public class ConstraintManagerTest {
  ...
  @Test
  public void testFindByIdAndPath() throws ProfileParserException, IOException,
      XPathExpressionException {

    // 1.0 Conformance statements
    String constraints =
        IOUtils.toString(ConstraintManagerTest.class
    ...
    Set<Constraint> cols =
        manager.findConfStatementsByIdAndPath("Segment", "8dfae017-9261-46e0-98f9-d1bea58734af",
            "1[1]");
    ...
    cols =
        manager.findConfStatementsByIdAndPath("Segment", "092444dd-273b-4b2d-84bd-0f0ddd06cf59",
            "20[1]");
    for (Constraint co : cols) {
      System.out.println(co.getId() + "-" + co.getDescription());
    }
