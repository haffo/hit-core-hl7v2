<xsl:stylesheet version="2.0"
	...
	<xsl:template match="report:SpecificReport">
		...
		<!-- <div id="mvrValidationContextBox" style="display:block;"> <br/> <table 
			...
			<tr> <td class="row1" rowspan="4" valign="top"> Validation Context <br/> 
			</td> <td class="row2">Name</td> <td class="row3"> <xsl:call-template name="FileName"> 
		...
		<!-- <div id="mvrAffirmatives" style="display:{$mvrAffirmativesDisplay}"> 
			...
			width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline"> 
			<tr> <th colspan="3">Validation Affirmative</th> </tr> <tr> <td colspan="4" 
	...
	<xsl:template match="report:MetaData/report:Message">
		...
		<!-- <tr> <td class="row2">Id</td> <td class="row3"> <xsl:value-of select="@Id"/> 
			</td> </tr> <tr> <td class="row2">File</td> <td class="row3"> <xsl:value-of 
	...
	<xsl:template name="Summary">
		...
		<!-- <tr> <td class="row1">Affirmatives</td> <td class="row2"> <xsl:value-of 
			select="../report:HeaderReport/message:AffirmCount"/> </td> </tr> -->
		<tr>
