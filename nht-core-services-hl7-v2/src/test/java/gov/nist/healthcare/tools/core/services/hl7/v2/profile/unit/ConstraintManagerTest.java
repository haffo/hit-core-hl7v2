...
public class ConstraintManagerTest {
	...
	@Test
	public void testFindById() throws ProfileParserException, IOException, XPathExpressionException{
		...
		String constraints =  IOUtils.toString(ConstraintManagerTest.class.getResourceAsStream("/new_validation/ConformanceStatementConstraints.xml"));
 		...
 		Set<Constraint> cols = manager.findById("Segment", "8dfae017-9261-46e0-98f9-d1bea58734af");
 		System.out.println("--------------->Conformance Statements:8dfae017-9261-46e0-98f9-d1bea58734af<-------------------");
	...
	public void testFindByIdAndPath() throws ProfileParserException, IOException, XPathExpressionException{
		...
		String constraints =  IOUtils.toString(ConstraintManagerTest.class.getResourceAsStream("/new_validation/ConformanceStatementConstraints.xml"));
 		...
 		Set<Constraint> cols = manager.findByIdAndPath("Segment", "8dfae017-9261-46e0-98f9-d1bea58734af","1[1]"); 
 		...
 		cols = manager.findByIdAndPath("Segment", "092444dd-273b-4b2d-84bd-0f0ddd06cf59","20[1]"); 
 		for(Constraint co: cols){
 			System.out.println(co.getId() + "-" + co.getDescription());
 		}
 		assertFalse(cols.isEmpty());
 		...
 		cols = manager.findByIdAndPath("Segment", "092444dd-273b-4b2d-84bd-0f0ddd06cf59","6[1]"); 
 		for(Constraint co: cols){
 			System.out.println(co.getId() + "-" + co.getDescription());
 		}
 		assertFalse(cols.isEmpty());
 		...
 		cols = manager.findByIdAndPath("Segment", "8dfae017-9261-46e0-98f9-d1bea58734af","7[1].1[1]"); 
 		for(Constraint co: cols){
 			System.out.println(co.getId() + "-" + co.getDescription());
 		}
 		assertFalse(cols.isEmpty());
